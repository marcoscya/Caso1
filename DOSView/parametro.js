...
/*==========================Nuevo cambio drop area=================================*/
// Obtén la zona de arrastre y el formulario
const dropArea = document.getElementById('drop-area');
const fileInput = document.getElementById('archivo');
const container2 = document.getElementById('container2');

// Maneja el evento 'drop' para múltiples archivos
dropArea.addEventListener('drop', (e) => {
    e.preventDefault();
    dropArea.classList.remove('drag-over');
...
function handleFiles(files) {
    ...
    .then(data => {
        ...
        // Puedes actualizar container2 con el resultado si es necesario
    })
    .catch(error => {
...
function displayFile(file) {
    ...
    fileElement.textContent = file.name; // Muestra el nombre del archivo
    container2.appendChild(fileElement);
}
/*========================================================================================*/
